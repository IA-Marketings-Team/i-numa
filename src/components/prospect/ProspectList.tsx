...
import { AppelForm } from '../communication/AppelForm';
...
const ProspectList: React.FC = () => {
  ...
  // Effet pour initialiser les appels
  useEffect(() => {
  ...
  useEffect(() => {
    if (activeTab === 'all') {
      ...
      const filteredByTab = appels.filter(appel => appel.statut === activeTab);
  ...
  const confirmDelete = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "La fiche de prospection a été supprimée avec succès",
      });
    ...
    <div className="space-y-6">
          ...
          <div className="grid gap-4 grid-cols-1 lg:grid-cols-2">
            {loading ? (
              ...
              filteredAppels.map(appel => (
                <Card key={appel.id} className="overflow-hidden border shadow-sm hover:shadow-md transition-shadow bg-white">
      ...
      <Dialog open={isViewDialogOpen} onOpenChange={setIsViewDialogOpen}>
        <DialogContent className="sm:max-w-xl">
          <DialogHeader>
            <DialogTitle>Détails de la fiche de prospection</DialogTitle>
          </DialogHeader>
          {selectedAppel && (
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent className="sm:max-w-xl">
          <DialogHeader>
            <DialogTitle>Modifier la fiche de prospection</DialogTitle>
          </DialogHeader>
          <AppelForm 
